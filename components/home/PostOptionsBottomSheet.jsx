...
const PostOptionsBottomSheet = ({
    ...
    const reportTypes = [
        ...
        { id: "explicit", label: "Sexually Explicit Content" },
    ...
    const handleReportPost = () => {
        ...
        setIsReporting(true);
        network
            .post(API_PATHS.reportPost, {
                postId: postDetails.id,
                reporterId: currentUserId,
                reportedUserId: authorDetails.id,
            ...
            .then(() => {
                if (Platform.OS === "android") {
                    ...
                    Alert.alert(
                        "Report Submitted",
                        "Thank you. We'll review this content within 24 hours."
                    );
                }
                onClose();
    ...
    const handleBlockUser = () => {
        Alert.alert(
            ...
            `Are you sure you want to block @${
                authorDetails.userName || "this user"
                    ...
                    onPress: () => {
                        ...
                        network
                            .post(API_PATHS.blockUser, {
                                ...
                                blockedUserId: authorDetails.id,
                            })
                            .then(() => {
                                if (Platform.OS === "android") {
                                    ToastAndroid.showWithGravityAndOffset(
                                ...
                                onBlockUser && onBlockUser(authorDetails.id);
                                onClose();
                            })
                            .catch(() => {
                                Alert.alert(
