while true; do  
    ...
    echo "$(date '+%Y-%m-%d %H:%M:%S %Z')" >> /Users/pavankurmakoka/Documents/tutorials/projects/experiments/trade-tribe-app/bash.log
...
' \
    --header 'Cookie: JSESSIONID=6ED9CE97589DDC7266E1A1D73B87241C' >> /Users/pavankurmakoka/Documents/tutorials/projects/experiments/trade-tribe-app/bash.log 2>&1  
